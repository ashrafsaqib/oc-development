...
<?php if ($designer_enabled) { ?>
            <div class="tab-pane" id="tab-custom">
              ...
              <!-- Modal -->
              <div class="modal fade" id="productDesigner" tabindex="-1" data-iframe-url="<?php echo $iframe_url; ?>?p_id=<?php echo $_GET['product_id']; ?>&base=<?php echo $base; ?>&admin=true" role="dialog" aria-labelledby="productDesignerLabel" aria-hidden="true">
...
function resetIframe() {
  ...
  $("#productDesigner").attr('data-iframe-url', '<?php echo $iframe_url; ?>?base=<?php echo $base; ?>&admin=true&product_id=<?php echo $_GET['product_id']; ?>');
}
