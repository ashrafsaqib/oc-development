      ...
      <div class="modal-dialog" role="document" style="width: 95%; max-width: 95%; height: 95%; margin: 2.5% auto;">
        <div class="modal-content" style="height: 100%;">
          ...
          <div class="modal-body" style="padding:0; height: calc(100% - 51px); overflow: hidden;">
            <iframe src="<?php echo $iframe_url; ?>?cart_id=<?php echo $product['cart_id']; ?>&base=<?php echo $base; ?>&preview=true&strict=true" allowfullscreen style="width:100%;height:100%;border:none;"></iframe>
          </div>
        </div>
      </div>
    </div>
